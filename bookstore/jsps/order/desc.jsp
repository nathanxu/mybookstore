...
<table border="1" width="100%" cellspacing="0" background="black">
	<tr bgcolor="gray" bordercolor="gray">
		<td colspan="6">
			订单编号：${requestScope.order.oid}　成交时间：${requestScope.order.ordertime}　金额：<font color="red"><b>${requestScope.order.total}元</b></font>
		</td>
	</tr>

<c:forEach items="${requestScope.order.list}" var="orderItem">
...
<br/>
<form method="post" action="${pageContext.request.contextPath }/OrderServlet?method=payOrder" id="form" target="_parent">
	收货地址：<input type="text" name="address" size="50" value=""/><br/>
